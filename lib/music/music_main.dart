...
Widget body=LikedSongs();
String appBarTitle="Liked Songs";
...
class _MusicMainState extends State<MusicMain> {
  ...
  void randomize() {
    ...
    setState(() {
      for (int i = 0; i < Songs.songs.length; i++) {
        if(DeepCollectionEquality().equals(randomSongs[i], Songs.songs[Songs.songNumber])==true){
          print("Yes");
          Songs.songNumber=i;
          break;
        }
  ...
  Widget build(BuildContext context) {
    ...
    return SlidingUpPanel(
      body: Scaffold(
        appBar: AppBar(
          title: Text(appBarTitle,style: TextStyle(color: Colors.black,letterSpacing: 2),),
          centerTitle: true,
